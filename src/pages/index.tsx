    ...
    <Layout transparentHeader={false}>
      ...
      <main>
        ...
        <Section
          ...
          Incidents may involve urban searches, lost or injured hikers, or complex rescues in steep and technical terrain. Operating under Emergency Management and Climate Readiness (EMCR), LBSAR works closely with neighbouring search and rescue teams 
        ...
        <Section
          ...
          body={
            <>
              If a <span className='font-bold'>helicopter response</span> is required, crews may conduct an initial reconnaissance flight to assess terrain and plan a safe extraction. To help rescuers locate you, make yourself visible by wearing <span className='font-bold text-red-600'>bright colours</span>, waving your arms, and using a <span className='font-bold text-red-600'>headlamp or light</span> if conditions allow. Dark or neutral clothing such as gray, black, or green can be difficult to see beneath dense West Coast forest canopy.<br /><br />
